...
public class EnchantAll {
    ...
    public static void registerCommand(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        ...
        final LiteralCommandNode<FabricClientCommandSource> enchantAllNode = dispatcher.register(
                CommandUtils.runnable(ENCHANT_COMMAND, () -> onEnchantAllCommand(false, false))
                    ...
                    .then(CommandUtils.getterSetter("mode", "mode", "enchantAll.enchantMode", () -> ModConfig.INSTANCE.enchantAll.enchantMode, (value) -> ModConfig.INSTANCE.enchantAll.enchantMode = value, ModConfig.EnchantMode.EnchantModeArgumentType.enchantMode(), ModConfig.EnchantMode.EnchantModeArgumentType::getEnchantMode))
                    .then(CommandUtils.doubl("delay", "seconds", "enchantAll.enchantDelay", () -> ModConfig.INSTANCE.enchantAll.enchantDelay, (value) -> ModConfig.INSTANCE.enchantAll.enchantDelay = value))
                    .then(CommandUtils.integer("cooldownFrequency", "frequency", "enchantAll.cooldownFrequency", () -> ModConfig.INSTANCE.enchantAll.cooldownFrequency, (value) -> ModConfig.INSTANCE.enchantAll.cooldownFrequency = value))
                    .then(CommandUtils.doubl("cooldownTime", "seconds", "enchantAll.cooldownTime", () -> ModConfig.INSTANCE.enchantAll.cooldownTime, (value) -> ModConfig.INSTANCE.enchantAll.cooldownTime = value))
                    .then(CommandUtils.bool("excludeFrost", "enchantAll.excludeFrost", () -> ModConfig.INSTANCE.enchantAll.excludeFrost, (value) -> ModConfig.INSTANCE.enchantAll.excludeFrost = value))
        );
    ...
    public static void tick() {
        ...
        if (noPermission) {
            if (ModConfig.INSTANCE.enchantAll.enchantMode == ModConfig.EnchantMode.ALL && enchanting) {
        ...
        if (commandCount >= ModConfig.INSTANCE.enchantAll.cooldownFrequency) {
            cooldown = true;
            Messenger.printEnchantCooldown(ModConfig.INSTANCE.enchantAll.cooldownTime);
            commandCount = 0;
        }
    ...
    private static void sendNextEnchant(List<Enchantment> enchants, boolean unenchant) {
        if (!unenchant && ModConfig.INSTANCE.enchantAll.enchantMode == ModConfig.EnchantMode.ALL) {
    ...
    private static int delayLeft() {
        long delay = (long)(ModConfig.INSTANCE.enchantAll.enchantDelay * 1000.0);
        if (cooldown) {
