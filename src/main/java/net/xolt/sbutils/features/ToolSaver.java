...
public class ToolSaver {
    ...
    public static void registerCommand(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        ...
        final LiteralCommandNode<FabricClientCommandSource> toolSaverNode = dispatcher.register(
                CommandUtils.toggle(COMMAND, "toolSaver", () -> ModConfig.INSTANCE.toolSaver.toolSaver, (value) -> ModConfig.INSTANCE.toolSaver.toolSaver = value)
                    .then(CommandUtils.integer("durability", "durability", "toolSaver.toolSaverDurability", () -> ModConfig.INSTANCE.toolSaver.toolSaverDurability, (value) -> ModConfig.INSTANCE.toolSaver.toolSaverDurability = value))
        );
    ...
    public static boolean shouldCancelBlockInteract(ClientPlayerEntity player, Hand hand, BlockHitResult hitResult) {
        if (!ModConfig.INSTANCE.toolSaver.toolSaver) {
            return false;
        }
    ...
    public static boolean shouldCancelAttack() {
        if (!ModConfig.INSTANCE.toolSaver.toolSaver || MC.player == null) {
            return false;
        }
    ...
    private static boolean hasLowDurability(ItemStack item) {
        ...
        return item.getMaxDamage() - item.getDamage() <= ModConfig.INSTANCE.toolSaver.toolSaverDurability;
    }
