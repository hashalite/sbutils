...
public class CustomListOptionImpl<T> implements ListOption<T>{
    ...
    public static final class BuilderImpl<T> implements ListOption.Builder<T> {
        ...
        public CustomListOptionImpl.BuilderImpl<T> name(@NotNull Component name) {
            Validate.notNull(name, "`name` must not be null", new Object[0]);
            this.name = name;
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> tooltip(Component... tooltips) {
            Validate.notEmpty(tooltips, "`tooltips` cannot be empty", new Object[0]);
            this.tooltipLines.addAll(List.of(tooltips));
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> initial(@NotNull T initialValue) {
            Validate.notNull(initialValue, "`initialValue` cannot be empty", new Object[0]);
            this.initialValue = initialValue;
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> controller(@NotNull Function<ListOptionEntry<T>, Controller<T>> control) {
            Validate.notNull(control, "`control` cannot be null", new Object[0]);
            this.controllerFunction = control;
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> binding(@NotNull Binding<List<T>> binding) {
            Validate.notNull(binding, "`binding` cannot be null", new Object[0]);
            this.binding = binding;
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> binding(@NotNull List<T> def, @NotNull Supplier<@NotNull List<T>> getter, @NotNull Consumer<@NotNull List<T>> setter) {
        ...
        public CustomListOptionImpl.BuilderImpl<T> available(boolean available) {
            this.available = available;
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> flag(OptionFlag... flag) {
            Validate.notNull(flag, "`flag` must not be null", new Object[0]);
            this.flags.addAll(Arrays.asList(flag));
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> flags(@NotNull Collection<OptionFlag> flags) {
            Validate.notNull(flags, "`flags` must not be null", new Object[0]);
            this.flags.addAll(flags);
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> collapsed(boolean collapsible) {
            this.collapsed = collapsible;
            return this;
        }

        public CustomListOptionImpl.BuilderImpl<T> maximumNumberOfEntries(int maximumNumberOfEntries) {
            this.maximumNumberOfEntries = maximumNumberOfEntries;
            return this;
        }
