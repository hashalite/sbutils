...
public class InvUtils {
    ...
    public static Map<Enchantment, Integer> getEnchantments(ItemStack itemStack) {
        ...
        itemEnchantments.keySet().forEach(enchantment -> {
            enchantments.put(enchantment.value(), itemEnchantments.getLevel(enchantment.value()));
        });
    ...
    public static Enchantment getEnchantment(ResourceKey<Enchantment> enchantment) {
        ...
        HolderLookup.RegistryLookup<Enchantment> registry = MC.level.registryAccess().lookupOrThrow(Registries.ENCHANTMENT);
